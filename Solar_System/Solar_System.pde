...
void instructions(){
  textFont(font, 28);
  text("To pilot Millennium Falcon", -1050, 560, 0);
  text("Press A-D to move RIGHT/LEFT", -1050, 600, 0);
  text("Press W-S to move UP/DOWN", -1050, 640, 0);
  text("Press K-L to move FORWARD/BACKWARD", -1050, 680, 0);
}
